...
func (c *packagesClient) CreateProtoPackage(ctx context.Context, opts ...grpc.CallOption) (Packages_CreateProtoPackageClient, error) {
	stream, err := c.cc.NewStream(ctx, &Packages_ServiceDesc.Streams[0], "/build.stack.protobuf.package.v1alpha2.Packages/CreateProtoPackage", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *packagesClient) GetProtoPackage(ctx context.Context, in *GetProtoPackageRequest, opts ...grpc.CallOption) (*ProtoPackage, error) {
	...
	err := c.cc.Invoke(ctx, "/build.stack.protobuf.package.v1alpha2.Packages/GetProtoPackage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Packages_GetProtoPackage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/build.stack.protobuf.package.v1alpha2.Packages/GetProtoPackage",
	}
...
var Packages_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "build.stack.protobuf.package.v1alpha2.Packages",
	...
	Metadata: "build/stack/protobuf/package/v1alpha2/package.proto",
}
